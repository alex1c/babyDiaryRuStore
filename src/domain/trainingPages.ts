...
export const TRAINING_PAGES: TrainingPage[] = [
	...
	},
	{
		...
		title: 'Напоминания',
		body:
			'Напоминания создаёте только вы — по умолчанию приложение ничего не навязывает. Можно настроить витамин, лекарство, врача, кормление или своё событие.',
	...
	},
	{
		...
		body:
			'Быстрая копия сохраняет данные без фотографий. Полная — данные, фотографии и документы.',
		callout:
